	...
	<div class="nytxt3">
		<form id="userForm" name="userForm" method="post" action="">
			<table width="100%" border="0" style="margin-top:20px;" class="table1">
				<tr>
					<td height="30" colspan="2" align="left">密码丢失？请输入以下信息通过邮件找回</td>
				</tr>
				<tr>
					<td width="28%" height="30" align="right">用户名：</td>
					<td width="72%" height="30"><input name="userName" type="text" id="userName" value="" style="width:200px;" /></td>
				</tr>
				<tr>
					<td height="30" align="right">E-mail：</td>
					<td height="30"><input name="email" type="text" id="email" value="" style="width:200px;" />
						填写邮箱地址</td>
				</tr>
				<tr>
					<td height="30">&nbsp;</td>
					<td height="30"><input type="submit" name="button" id="button" value="发送邮件" class="button" />
					</td>
				</tr>
			</table>
		</form>
