...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="navigation">
    <tr>
        <td class="content"><span class="description">当前位置：</span>充值记录</td>
        <td align="right"></td>
    </tr>
</table>
...
?>
        <tr class="dataLine">
            ...
            <td align="center"><?php if ($row['type'] == 1) {echo '线上支付';} else if ($row['type'] == 2) {echo '线下转账';} else if ($row['type'] == 3) {echo '其他';};?></td>
            <td align="center"><?php echo trim($row['from']) != '' ? $row['from'] : '--';?></td>
          	<td align="center"><?php echo trim($row['serialNumber']) != '' ? $row['serialNumber'] : '--';?></td>
          	<td align="center"><?php echo $row['paymentTime'];?></td>
            ...
            <td class="line"><?php echo $row['notes'];?></td>
...
?>
    ...
    <tr>
        <td colspan="10" class="paginator"><?php echo $this->pageString;?></td>
    </tr>
</table>
</body>
</html>