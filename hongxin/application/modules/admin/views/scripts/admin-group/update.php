...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="navigation">
    <tr>
        <td class="content"><span class="description">当前位置：</span><a href="<?php echo $this->projectUrl(array('action'=>'index')) ;?>">用户组列表</a> &gt; 修改用户组</td>
    </tr>
</table>
<form id="editorForm" name="editorForm" method="post" action="">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
        <tr>
            <td width="12%">名称：</td>
            <td width="88%"><input name="name" type="text" class="input inputCommonSize" id="name" size="50" maxlength="50" value="<?php echo $this->row['name']?>" />
            必填</td>
        </tr>
        <tr>
            <td>描述：</td>
